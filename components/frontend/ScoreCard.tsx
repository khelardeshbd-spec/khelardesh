        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span
            style={{
              ...
              color: isUpcoming ? 'var(--ink)' : winnerA ? 'var(--ink)' : isDraw ? 'var(--ink-muted)' : 'var(--ink-ghost)',
              overflow: 'hidden',
              textOverflow: 'ellipsis',
              whiteSpace: 'nowrap',
            }}
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span
            style={{
              ...
              color: isUpcoming ? 'var(--ink)' : winnerB ? 'var(--ink)' : isDraw ? 'var(--ink-muted)' : 'var(--ink-ghost)',
              overflow: 'hidden',
              textOverflow: 'ellipsis',
              whiteSpace: 'nowrap',
            }}
