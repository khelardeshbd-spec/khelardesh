    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Column 3: Legal & Essential Links */}
          <div className="flex flex-col gap-3">
            <h3 
              lang="bn"
              className="text-sm font-bold text-[var(--ink)] tracking-wider" 
          ...
          <div className="flex flex-col gap-4">
            ...
            <p 
              className="text-[11px] text-[var(--ink-muted)] mt-auto"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Powered by{' '}
              <a 
        ...
        <div className="border-t border-[var(--ink-border)] mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p 
            lang="bn"
            style={{
